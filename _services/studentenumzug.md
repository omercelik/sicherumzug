...
checklist:
- Bereitstellung von [Umzugskartons](/ratgeber/umzugskartons-verpackungsmaterial-berechnen/) und Material
- Nur Transport (Sie packen, wir fahren)
- Möbelmontage für IKEA-Schränke und Co.
- Unterstützung bei [Zimmer-Auflösungen](/leistungen/zimmer-raeumung-wien-wg-uebergabe/)

process:
- title: "Anfrage & Planung"
  description: "Melden Sie sich rechtzeitig vor Semesterbeginn bei uns. Wir klären den Bedarf für Ihren Umzug in die WG oder Studentenwohnung."
- title: "Flexible Lösungen"
  description: "Wählen Sie zwischen reinem Transport (Sie packen selbst) oder Full-Service inkl. Montage. Wir passen uns Ihrem Budget an."
- title: "Zuverlässiger Transport"
  description: "Unsere über 15 Jahre Erfahrung sorgen dafür, dass Ihr WG-Umzug pünktlich und stressfrei verläuft."
...
- question: Können Sie auch nur ein einzelnes gebrauchtes Sofa transportieren?
  answer: Ja, für Willhaben-Einkäufe oder den Transport einzelner Möbelstücke bieten
    wir schnelle und günstige Kleintransporte an. Lesen Sie hier mehr zu unseren [Tipps für Studentenumzüge](/ratgeber/studentenumzug-oesterreich-wg-tipps/).
