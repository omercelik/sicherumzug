...
4. Update `_guides/2026-08-15-ultimative-umzugs-checkliste.md`: Add a TL;DR section for AI extraction and link back to Umzug Wien.
5. Create `phase-4-4-ai-entity-implementation-report.md`.
6. Run jekyll build.
7. Submit.
