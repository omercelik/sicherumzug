    ...
    <div class="max-w-3xl space-y-5">
      ...
      <div class="flex flex-col gap-3 text-sm font-semibold uppercase tracking-[0.2em] text-white/80 sm:flex-row sm:items-center">
        <div class="inline-flex items-center gap-2">
          {% include svg/verified.svg class="text-base fill-current w-1em h-1em" %}
          Fixpreis &amp; Wertanrechnung bestätigt
        </div>
        <div class="inline-flex items-center gap-2">
          {% include svg/shield_with_heart.svg class="text-base fill-current w-1em h-1em" %}
    ...
    <div class="grid gap-12 lg:grid-cols-2">
      <div class="space-y-5">
        ...
        <ul class="space-y-3 text-base text-text-light">
          <li class="flex items-start gap-3">{% include svg/check_circle.svg class="text-gray-800 fill-current w-1em h-1em" %}<span>Verifizierte Teams vor Ort dokumentieren den Zustand vor &amp; nach der Räumung.</span></li>
          <li class="flex items-start gap-3">{% include svg/check_circle.svg class="text-gray-800 fill-current w-1em h-1em" %}<span>Wertanrechnung und Entsorgung werden schriftlich bestätigt, kein Nachverhandeln.</span></li>
          <li class="flex items-start gap-3">{% include svg/check_circle.svg class="text-gray-800 fill-current w-1em h-1em" %}<span>Terminfenster und Schlüsselübergaben werden protokolliert – ideal für Hausverwaltungen.</span></li>
        </ul>
      </div>
