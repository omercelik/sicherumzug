    ...
    <div class="grid gap-12 lg:grid-cols-2">
      <div class="space-y-5">
        ...
        <ul class="space-y-3 text-base text-text-light">
          <li class="flex items-start gap-3">{% include svg/check_circle.svg class="w-[18px] h-[18px] shrink-0 text-gray-800 fill-current" %}<span>Verifizierte Teams vor Ort dokumentieren den Zustand vor &amp; nach der Räumung.</span></li>
          <li class="flex items-start gap-3">{% include svg/check_circle.svg class="w-[18px] h-[18px] shrink-0 text-gray-800 fill-current" %}<span>Wertanrechnung und Entsorgung werden schriftlich bestätigt, kein Nachverhandeln.</span></li>
          <li class="flex items-start gap-3">{% include svg/check_circle.svg class="w-[18px] h-[18px] shrink-0 text-gray-800 fill-current" %}<span>Terminfenster und Schlüsselübergaben werden protokolliert – ideal für Hausverwaltungen.</span></li>
        </ul>
      </div>
