...
tags:
  ...
  - entsorgung
faqs:
  - question: "Müssen Akten DSGVO-konform vernichtet werden?"
    answer: "Ja, Patientendaten müssen geschützt entsorgt werden. Wir stellen auf Wunsch Vernichtungsnachweise bereit."
  - question: "Was passiert mit Medizingeräten?"
    answer: "Wir trennen funktionstüchtige Geräte, vermitteln Verwertung oder Entsorgung und dokumentieren den Abtransport."
permalink: /ratgeber/praxisaufloesung-checkliste/
---

Eine Praxisauflösung erfordert klare Schritte, saubere Dokumentation und sensible Abläufe. Hier ist eine kompakte Checkliste für Wien, damit die Übergabe planbar bleibt.

## Schritt 1: Bestandsaufnahme

- Räume, Nebenräume und Lagerflächen erfassen
- Inventar, Geräte und Verbrauchsmaterialien auflisten
- Termine mit Hausverwaltung und Vermieter abstimmen

## Schritt 2: Datenschutz und Akten

- Patientendaten in Papierform sicher trennen
- Datenträger und Server erfassen
- Vernichtung nur mit Nachweis und Dokumentation

## Schritt 3: Medizingeräte und Einrichtung

- Funktionsfähige Geräte identifizieren
- Demontage von Einbauten und Sanitärbereichen planen
- Entsorgung von Altgeräten mit Fachpartnern koordinieren

## Schritt 4: Räumung und Übergabe

- Tragewege und Liftzeiten klären
- besenreine Hinterlassung mit Fotoprotokoll
- Schlüsselrückgabe dokumentieren

## Kosten und Fixpreis

Nach der Besichtigung erhalten Sie einen Fixpreis. Wertanrechnung ist möglich, wenn verwertbare Geräte oder Einrichtung vorhanden sind.

## Unterstützung für Praxisauflösungen

Wir übernehmen Praxisauflösungen in Wien und stimmen uns mit Hausverwaltung, Vermietern und internen Teams ab. Details zum gewerblichen Ablauf finden Sie unter [Firmen- und Büroauflösung](/leistungen/firmenaufloesung/) sowie im Leitfaden [Büro- und Gewerberäumung DSGVO-konform abwickeln](/ratgeber/buero-und-gewerberaemung/).
...
Bei der Praxisauflösung müssen nicht nur Büromöbel transportiert werden, sondern auch sensible medizinische Geräte. Wir garantieren den fachgerechten und sicheren Transport sowie die Einhaltung aller Datenschutzrichtlinien bei der Vernichtung von Patientenakten.
