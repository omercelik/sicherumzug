...
date: 2024-05-17
category: "Ratgeber"
permalink: /ratgeber/verlassenschaftsankauf-notar-wien/
primary_query: "verlassenschaftsankauf wien"
intent_stage: "informational"
cluster: "problem-solving"
last_reviewed: 2024-05-17
tags:
  - verlassenschaft
  - notar
  - wertanrechnung
  ...
  - erbe
faqs:
  - question: "Wann darf ich eine Verlassenschaft in Wien räumen?"
    answer: "Erst nach der Freigabe durch den zuständigen Notar (Gerichtskommissär). Eine vorherige Räumung kann rechtliche Konsequenzen haben und den Tatbestand der Erbschaftserschleichung erfüllen."
  - question: "Was ist der Unterschied zwischen Entrümpelung und Verlassenschaftsankauf?"
    answer: "Bei einer reinen Entrümpelung zahlen Sie für die Entsorgung. Beim Verlassenschaftsankauf werden werthaltige Gegenstände (Antiquitäten, Schmuck, Möbel) gegen die Räumungskosten aufgerechnet (Wertanrechnung) oder bar abgelöst."
  - question: "Muss der Notar bei der Schätzung des Inventars anwesend sein?"
    answer: "Nicht zwingend bei jedem Objekt. Oft reicht ein Inventarverzeichnis, das von zertifizierten Schätzmeistern oder professionellen Verlassenschafts-Experten im Zuge eines Räumungsangebots erstellt wird."
  - question: "Wie finde ich heraus, welcher Notar in Wien zuständig ist?"
    answer: "Der zuständige Notar wird vom Bezirksgericht des letzten Wohnsitzes des Verstorbenen automatisch bestellt. Das Verlassenschaftsgericht benachrichtigt die Erben schriftlich."
---
...
3.  **Inventarisierung (Inventarerrichtung):** Das gesamte Vermögen (Aktiva und [Passiva/Nachlassverbindlichkeiten](/ratgeber/nachlassverbindlichkeiten-wohnungsaufloesung/)) muss ermittelt werden. Dazu gehört auch der Hausrat.
...
Die [Wohnungsauflösung](/leistungen/haushaltsaufloesung/) einer gesamten Wohnung verursacht Entsorgungskosten (Personal, Transport, MA 48 Gebühren). Bei einer Verlassenschaft lassen sich diese Kosten jedoch oft durch den Wert des Inventars minimieren.

Der Prozess des Verlassenschaftsankaufs (mit [Wertanrechnung](/ratgeber/wertanrechnung-guide/)) funktioniert so:

1.  **Gratis Erstbesichtigung:** Ein Experte der Räumungsfirma besichtigt die Wohnung (nach Freigabe durch den Notar).
...
Eine professionelle Verlassenschaftsfirma bietet alles aus einer Hand: Ankauf, Entrümpelung, besenreine Hinterlassung und oft auch die direkte Kooperation mit Ihrem Notar für erforderliche Schätzgutachten.

Benötigen Sie Unterstützung bei einer Verlassenschaft in Wien? Wir bieten Ihnen eine diskrete Besichtigung und ein transparentes Angebot mit fairer Wertanrechnung an. Starten Sie hier Ihre [Anfrage](/angebot/).
