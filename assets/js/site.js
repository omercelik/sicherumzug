...
document.addEventListener('DOMContentLoaded', function domReady() {
  ...
  if (photosInput && previewContainer) {
    ...
    function renderPreviews() {
      ...
      selectedFiles.forEach(function(file, index) {
        ...
        btn.innerHTML = `<svg class="w-4 h-4 shrink-0 !font-bold fill-current" xmlns="http://www.w3.org/2000/svg"  viewBox="0 -960 960 960" ><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg>`;
  ...
  function setFieldError(input, errorMsg) {
    ...
    if (errorMsg) {
      ...
      errorEl.innerHTML = `<svg class="w-4 h-4 shrink-0 !font-bold inline fill-current" xmlns="http://www.w3.org/2000/svg"  viewBox="0 -960 960 960" ><path d="m40-120 440-760 440 760H40Zm138-80h604L480-720 178-200Zm302-40q17 0 28.5-11.5T520-280q0-17-11.5-28.5T480-320q-17 0-28.5 11.5T440-280q0 17 11.5 28.5T480-240Zm-40-120h80v-200h-80v200Zm40-100Z"/></svg>` + `<span>${errorMsg}</span>`;
  ...
  function updatePostcodeFeedback() {
    ...
    if (/^[0-9]{4}$/.test(val)) {
      ...
      if (region) {
        ...
        regionEl.innerHTML = `<svg class="w-4 h-4 shrink-0 !font-bold inline fill-current" xmlns="http://www.w3.org/2000/svg"  viewBox="0 -960 960 960" ><path d="m424-296 282-282-56-56-226 226-114-114-56 56 170 170Zm56 216q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>` + `<span>Region: ${region} (Service verfügbar)</span>`;
            ...
            responseDiv.innerHTML = `
              <div class="flex justify-center">
                <div class="flex h-24 w-24 items-center justify-center rounded-full bg-green-100 shadow-inner">
                  <svg class="w-12 h-12 shrink-0 text-green-600 fill-current mx-auto" xmlns="http://www.w3.org/2000/svg"  viewBox="0 -960 960 960" ><path d="m424-296 282-282-56-56-226 226-114-114-56 56 170 170Zm56 216q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
                </div>
              </div>
              ...
              <div class="mt-6 inline-flex items-center gap-2 rounded-full bg-green-600 px-6 py-3 text-white font-bold shadow-md">
                <svg class="w-[18px] h-[18px] shrink-0 fill-current" xmlns="http://www.w3.org/2000/svg"  viewBox="0 -960 960 960" ><path d="M760-480q0-117-81.5-198.5T480-760v-80q75 0 140.5 28.5t114 77q48.5 48.5 77 114T840-480h-80Zm-160 0q0-50-35-85t-85-35v-80q83 0 141.5 58.5T680-480h-80Zm198 360q-125 0-247-54.5T329-329Q229-429 174.5-551T120-798q0-18 12-30t30-12h162q14 0 25 9.5t13 22.5l26 140q2 16-1 27t-11 19l-97 98q20 37 47.5 71.5T387-386q31 31 65 57.5t72 48.5l94-94q9-9 23.5-13.5T670-390l138 28q14 4 23 14.5t9 23.5v162q0 18-12 30t-30 12ZM241-600l66-66-17-94h-89q5 41 14 81t26 79Zm358 358q39 17 79.5 27t81.5 13v-88l-94-19-67 67ZM241-600Zm358 358Z"/></svg>
